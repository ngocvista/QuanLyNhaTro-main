...
namespace MotelManagement.Data.Models
{
    public partial class MotelManagementContext : DbContext
    {
        ...
        public virtual DbSet<ArticleRoom> ArticleRoom { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=localhost,1433; Database=MotelManagements;User Id=sa;Password=212148;TrustServerCertificate=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ArticleRoom>(entity =>
            {
                entity.ToTable("ArticleRoom");
